      ...
      Solicitude.findById(_solicitude_id)
        ...
        .exec(function(err, solicitude) {
          if (!err) {
            ...
            _content.data['updatedBy'] = solicitude.updatedBy.profile.firstName+' '+solicitude.updatedBy.profile.lastName;
            _content.data['updatedAt'] = moment(solicitude.updatedAt).format('DD/MM/YYYY [a las] HH:m:SS');
