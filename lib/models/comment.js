    ...
    if (typeof(this.to) !== 'undefined' && this.to !== null) {
      ...
      Solicitude.findById(this.solicitude)
        ...
        .exec(function(err, solicitude) {
          ...
          if (this.type === 'Solicitude.pm') {

            if (this.createdBy !== solicitude.applicant._id) {
              jobs.create('CreateNotification', {
                to: solicitude.applicant._id,
                from: this.createdBy,
                message: 'Te a dejado un comentario',
                _class: 'Solicitude',
                _classId: this.solicitude
              })
              .priority('high')
              .save()
            }

            if (this.createdBy !== solicitude.editor._id) {
              jobs.create('CreateNotification', {
            ...
            if (this.createdBy !== solicitude.responsible._id) {
              jobs.create('CreateNotification', {
          ...
          if (this.type === 'Solicitude.internal') {
          ...
          if (this.type === 'Solicitude.provider') {

            if (this.createdBy !== solicitude.provider._id) {
              jobs.create('CreateNotification', {
