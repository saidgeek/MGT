...
var permissions = {
  ...
  CONTENT_MANAGER: {
    module: ['SOLICITUDE'],
    states: ['QUEUE_PROVIDER', 'PROCCESS', 'QUEUE_VALIDATION_MANAGER', 'PAUSE', 'REJECTED_BY_MANAGER', 'OK_BY_MANAGER', 'QUEUE_VALIDATION_CLIENT', 'REJECTED_BY_CLIENT', 'OK_BY_CLIENT'],
    roles:  [],
    solicitude: ['UPDATE']
  },
  PROVIDER: {
    module: ['SOLICITUDE'],
    states: ['PROCCESS', 'PAUSE', 'QUEUE_VALIDATION_CLIENT', 'REJECTED_BY_CLIENT', 'OK_BY_CLIENT'],
    roles:  [],
    solicitude: ['UPDATE']
  },
  CLIENT: {
    module: ['SOLICITUDE'],
    states: ['PROCCESS', 'QUEUE_VALIDATION_MANAGER', 'PAUSE', 'REJECTED_BY_MANAGER', 'OK_BY_MANAGER', 'QUEUE_VALIDATION_CLIENT'],
    roles:  [],
    solicitude: ['CREATE']
  }
